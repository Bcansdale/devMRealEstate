            ...
            <div className="fixed min-h-screen flex items-center justify-center w-full">
                <div className="bg-white shadow-xl rounded-2xl px-8 py-6 max-w-md text-[#444445]">
                    ...
                    <form>
                        ...
                        <div className="mb-4">
                            <label htmlFor="password" className="block text-sm font-medium text-[#444445] mb-2">Password</label>
                        ...
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                                <input type="checkbox" id="remember" className="h-4 w-4 rounded border-gray-300 text-[#444445] focus:ring-orange-500 focus:outline-none accent-[#444445]" defaultChecked/>
                                    <label htmlFor="remember" className="ml-2 block text-sm text-[#444445]">Remember me</label>
                            </div>
                            <a href="#"
                               className="text-sm text-[#444445] hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 duration-200">Create
                                                                                                                                                               Account</a>
                        </div>
                        <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#444445] hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 duration-200">Login</button>
                    </form>
                </div>
            </div>
            </div>
