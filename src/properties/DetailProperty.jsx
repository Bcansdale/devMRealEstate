...
function DetailProperty() {
    ...
    return (
        ...
        <div className="flex flex-col min-h-screen justify-center items-center bg-gray-800 opacity-90">
            <div className="max-w-full lg:w-[80vw] shadow-2xl shadow-[#444445] bg-[#fff] ">
                ...
                <section className="flex flex-col h-screen bg-white mb-[360px]">
                    <div
                        ...
                        <div className='grid-cols-1 mt-5'>
                            <h2 className='text-4xl text-[#444445] ml-20'>Mountain Side Mansion</h2>
                            <h3 className='text-1xl text-[#444445] ml-20'>351 W 800 N, Salt Lake City, UT, 84103</h3>
                        </div>
                        <div className="flex flex-col items-end pr-4 mr-20 mt-5">
                            <h3 className="text-4xl text-[#444445] ml-5">$17,000,000</h3>
                            <div className="flex justify-end">
                                <h3 className="text-1xl text-[#444445] mr-12">Share</h3>
                        ...
                        <div className='grid-cols-1 pr-4 mr-20'>
                        ...
                        <div className='grid-cols-1 ml-20'>
                            ...
                            <p className='text-[1rem] text-[#444445] '>Lorem ipsum odor amet, consectetuer adipiscing
                                                                       elit. Ultrices elit inceptos tempus auctor per
                                                                       erat aliquam augue vulputate. Libero nibh
                                                                       penatibus congue tortor vel sollicitudin finibus
                                                                       dis vulputate. Pretium maecenas dapibus enim
                                                                       mauris, habitasse at. Ornare congue parturient et
                                                                       vestibulum semper sem consectetur. Ridiculus
                                                                       egestas donec porta placerat morbi magnis vivamus
                                                                       quisque porttitor. Maximus nec feugiat lacinia
                                                                       massa maximus volutpat. Integer sodales torquent
                                                                       id lacus finibus sit. Nascetur maximus nunc
                                                                       pharetra adipiscing facilisis cubilia malesuada
                                                                       quisque. Vehicula justo fames montes torquent
                                                                       ultrices faucibus commodo. Ullamcorper maecenas
                                                                       sit taciti quisque mattis; ultrices ligula. Dolor
                                                                       quis vitae platea primis habitant non et odio.
                                                                       Placerat elit sodales penatibus risus suscipit
                                                                       faucibus ut platea. Velit felis nascetur fames
                                                                       urna faucibus mauris? Enim id sem aliquet
                                                                       vehicula pharetra cubilia.</p>             <p
                            className='text-[1rem] text-[#444445] '>Lorem ipsum odor amet, consectetuer adipiscing elit.
                                                                    Ultrices elit inceptos tempus auctor per erat
                                                                    aliquam augue vulputate. Libero nibh penatibus
                                                                    congue tortor vel sollicitudin finibus dis
                                                                    vulputate. Pretium maecenas dapibus enim mauris,
                                                                    habitasse at. Ornare congue parturient et vestibulum
                                                                    semper sem consectetur. Ridiculus egestas donec
                                                                    porta placerat morbi magnis vivamus quisque
                                                                    porttitor. Maximus nec feugiat lacinia massa maximus
                                                                    volutpat. Integer sodales torquent id lacus finibus
                                                                    sit. Nascetur maximus nunc pharetra adipiscing
                                                                    facilisis cubilia malesuada quisque. Vehicula justo
                                                                    fames montes torquent ultrices faucibus commodo.
                                                                    Ullamcorper maecenas sit taciti quisque mattis;
                                                                    ultrices ligula. Dolor quis vitae platea primis
                                                                    habitant non et odio. Placerat elit sodales
                                                                    penatibus risus suscipit faucibus ut platea. Velit
                                                                    felis nascetur fames urna faucibus mauris? Enim id
                                                                    sem aliquet vehicula pharetra cubilia.</p>
                        </div>
                        <div className='container pr-20'>
                            <h2 className="text-3xl text-[#444445] mt-2 mb-8">Property Map</h2>
                            <div
                                ref={mapContainerRef}
                                className="map-container flex flex-grow h-full w-full "
                            />
                        </div>
                    </div>
                </section>
