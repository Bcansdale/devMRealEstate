        ...
        <>
            <div className='grid justify-center'>
                <div className="grid grid-cols-3 justify-center items-center mt-5">
                    ...
                    <button><HiOutlineHomeModern size={'5rem'} color="#444445" className="mx-7 md:mx-24 px-1 "/></button>
            ...
            <div>
                <section className="flex flex-col items-center bg-white">
                    ...
                    <div className="flex items-center justify-center m-5 mt-10">
                        <Button variant="outlined" className="px-10 text-[1rem] text-[#444445]" onClick={() => setListingsToShow(listingsToShow + 8)}>Show More listings</Button>
                    </div>
                </section>
            </div>
        </>
