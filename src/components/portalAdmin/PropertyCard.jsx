...
function PropertyCard({ property }) {
  ...
  const handleCardClick = (propertyId) => {
    ...
    const body = document.querySelector("#propertyForm");
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <ul
          className="box-border flex list-none items-center justify-between border-t border-b border-solid border-gray-300 px-0 py-6"
          onClick={() => handleCardClick(property.propertyId)}
        >
