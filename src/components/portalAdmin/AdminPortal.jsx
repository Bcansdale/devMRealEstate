        ...
        <>
            ...
            <div className="flex justify-center items-center w-fill h-fill bg-[#444445] py-5">
                <div className="container mx-auto my-4 px-4">
                    <h2 className="flex justify-center items-center text-white text-5xl pb-2">Create a New Listing</h2>
                    <div className="w-full p-8 my-4 mr-auto bg-white rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold uppercase text-4xl text-[#444445]">Home Details</h1>
                        </div>
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                            ...
                            <div>
                                ...
                                <input
                                    className="w-full bg-[#444445] text-white mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                    type="number" placeholder="Square Feet"/>
                            </div>
                            <div>
                                <h2 className="text-[1.5rem] text-[#444445]">Category</h2>
                                <select
                                    className="w-full bg-[#444445] text-white mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline">
                                    <option value="" disabled selected className="text-gray-600">Category</option>
                                    <option>House</option>
                        ...
                        <div className="my-2">
                            ...
                            <textarea placeholder="Description"
                                      className="w-full h-32 bg-[#444445] text-[#444445] mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
                        </div>
                        <div>
                        ...
                        <div className="flex items-center justify-center m-5 mt-10">
                            <Button variant="outlined" className="px-10 text-[1rem] text-[#444445]">Submit
                                                                                                    listing</Button>
                        </div>
                    </div>
                </div>
