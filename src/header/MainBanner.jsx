                    ...
                    <div className="col-start-1 row-start-1 flex flex-col items-center justify-center mb-40">
                        ...
                        <div className="md:w-1/2 min-w-[350px] mt-24">
                            <div className="relative">
                                <input
                                    className="w-full bg-transparent placeholder:text-white text-[1.3rem] border border-white rounded-3xl pl-5 md:pl-8 lg:pr-28 py-3 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-white shadow-sm focus:shadow "
